...
For a real-time demo, the Lesson 1 code is slightly adjusted here such
that all other print statements are commented out, and only light 
sensor measurements are printed. By using the Serial Plotter feature
in the Arduino IDE (Tools-->Serial Plotter), this sketch provides a 
quick demo of real-time light measurements!
